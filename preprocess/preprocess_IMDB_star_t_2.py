...
save_prefix = 'data/preprocessed/IMDB_preprocessed_star_t_2/'
num_ntypes = 4
...
"""
expected_metapaths = [
    [(0, 1, 0), (0, 3, 2, 3, 0), (0, 3, 0)],
    [(1, 0, 1), (1, 0, 3, 2, 3, 0, 1), (1, 0, 3, 0, 1)],
    [(2, 3, 0, 3, 2), (2, 3, 0, 1, 0, 3, 2), (2, 3, 2)],
    [(3, 0, 3), (3, 0, 1, 0, 3), (3, 2, 3)]
]
